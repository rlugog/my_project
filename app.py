...
build_histogram = st.checkbox('Mostrar histograma de precios', key='histogram_prices')
if build_histogram:
...
build_scatter = st.checkbox('Mostrar gráfico de dispersión (Precio vs Kilometraje)', key='scatter_price_vs_mileage')
if build_scatter:
